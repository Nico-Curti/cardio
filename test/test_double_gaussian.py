...
def test_find_x_of_minima_on_signal_with_dicrotic_notches_and_perturbations():
...
def test_find_x_of_minima_on_signal_without_dicrotic_notches():
...
def test_find_x_of_minima_on_signal_with_perturbations_and_without_dicrotic_notches():
...
def test_total_gap_feature_on_signal_with_dicrotic_notches():
...
def test_fitting_parameters_feature_on_signal_with_dicrotic_notches():
...
def test_not_nan_output_of_features_from_dicrotic_notch_on_signal_without_dicrotic_notches():
...
def test_output_shape_of_features_from_dicrotic_notch_on_signal_without_dicrotic_notches():
...
def test_total_gap_feature_on_signal_without_dicrotic_notches():
...
def test_gaussian_distance_feature_on_signal_without_dicrotic_notches():
